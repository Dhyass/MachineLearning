...
"""
data=pn.merge(Gbpusd, Eurgbp, on='Date', how='inner', suffixes=('_GBPUSD', '_EURGBP'))

data[['Close_GBPUSD','Close_EURGBP']].plot(subplots=True, figsize=(12,8))

print(data)

## calcul de la correlayion 
correlation = data[['Close_GBPUSD','Close_EURGBP']].corr()
