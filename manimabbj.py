...
background_img = plt.imread(r'c:\Users\NONZOOU\Downloads\Python.png')  # Replace 'background_image.jpg' with the actual image file
ax0.imshow(background_img, extent=[-np.pi, np.pi, -1, 1], aspect='auto', alpha=0.5)  # Adjust extent as needed
